...
| `package.json` / `package-lock.json` | c | manter (revisar `@types/*`) | Deps de runtime todas em uso; `@types/react(-dom)` sem uso ativo, mas remover é opcional/baixo risco |
